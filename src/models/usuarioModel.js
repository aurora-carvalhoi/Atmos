...
function autenticar(email, senha) {
    ...
    var instrucaoSql = `
        SELECT idUsuario, nome, email, fkEmpresa as empresaId, razaoSocial, statusUsuario, tipoUsuario FROM usuario  JOIN empresa ON fkEmpresa = idEmpresa WHERE email = '${email}' AND usuario.senha = '${senha}';
    `;
