...
*/
 ...
 statusAlerta VARCHAR(15) NOT NULL DEFAULT "Pendente",
 CONSTRAINT PRIMARY KEY pkAlertas(idAlerta, fkServidor, fkEmpresa),
 CONSTRAINT fkServidor_alerta FOREIGN KEY (fkServidor) REFERENCES servidor(idServidor),
 CONSTRAINT fkEmpresa_alerta FOREIGN KEY (fkEmpresa) REFERENCES empresa(idEmpresa),
 CONSTRAINT chkStatusAlerta CHECK (statusAlerta IN ('Pendente', 'Em andamento', "Resolvido"))
 );
 
 CREATE TABLE alertasFuncionario (
 fkAlerta INT,
 fkServidor INT,
 fkEmpresa INT,
 fkFuncionario INT,
 dtAtribuicao DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
 CONSTRAINT PRIMARY KEY pkAlertasFuncionario(fkAlerta, fkServidor, fkEmpresa, fkFuncionario),
 CONSTRAINT fkAlerta_alertaFuncionario FOREIGN KEY (fkAlerta) REFERENCES alertas(idAlerta),
 CONSTRAINT fkServidor_alertaFuncionario FOREIGN KEY (fkServidor) REFERENCES servidor(idServidor),
 CONSTRAINT fkEmpresa_alertaFuncionario FOREIGN KEY (fkEmpresa) REFERENCES empresa(idEmpresa),
 CONSTRAINT fkFuncionario_alertaFuncionar FOREIGN KEY (fkFuncionario) REFERENCES usuario(idUsuario)
 );
