...
(nomeResponsavel, nomeEmpresa, cnpj, senha, statusCliente)
VALUES 
('Carlos Silva', 'Tech Solutions', '12345678000199', 'senhaEmpresa123', 'Ativo');

INSERT INTO cadastroEmpresa 
(nomeResponsavel, nomeEmpresa, cnpj, senha, statusCliente)
VALUES 
('Brandao', 'SPTech Consulting', '12345678000991', 'senhaEmpresa123', 'Ativo');

INSERT INTO cadastroEmpresa 
(nomeResponsavel, nomeEmpresa, cnpj, senha, statusCliente)
VALUES 
('Brandao', 'SPTech Consulting', '12345678000992','senha123', 'Ativo');
...
VALUES
(3,'SPTech', null, 'Bianca@atmos.com', '1985-06-15', '12345679810', 'Ativo', 'Gestor', 'RG1234765');

INSERT INTO usuario
(fkEmpresa, codigoAcesso, fkSuperior, email, dataNascimento, cpf, statusUsuario, tipoUsuario, documentoIdetificacao)
VALUES
(2,'SPTech', 2,'brandao@Sptech', '2000-07-15', '12345698702', 'Ativo', 'Gestor', 'RG1234765');
...
CREATE TABLE servidor (
    ...
    enderecoIP VARCHAR(100) NOT NULL,
